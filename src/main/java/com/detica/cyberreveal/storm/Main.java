...
public final class Main {
     ...
     */
    public static void main(final String[] args) throws AlreadyAliveException, InvalidTopologyException, IOException {
	String topologyName = null;

	if (args != null && args.length > 0) {
	    topologyName = args[0];
	}
	BookTopology topology = new BookTopology(topologyName, "src/main/resources/AdventuresOfSherlockHolmes.txt",
		new File("target/wordCounts.out"));
	topology.run();
    }
}
