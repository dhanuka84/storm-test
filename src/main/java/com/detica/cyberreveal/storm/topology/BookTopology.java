...
public final class BookTopology implements Runnable {
     ...
     */
    public BookTopology(String topologyName, String inputFile, File wordCountOutputFile) {
	...
	builder.setBolt("wordCount", new WordCountBolt(), 2).shuffleGrouping("wordSplitter");
	builder.setBolt("printWordCount", new PrinterBolt(), 2).shuffleGrouping("wordCount");
	try {
	    builder.setBolt("printWordCountToFile", new FilePrinterBolt(this.wordCountOutputFile), 2)
